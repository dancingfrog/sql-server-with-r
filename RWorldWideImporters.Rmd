...
# Remote
server <- "Server=ec2-52-21-198-129.compute-1.amazonaws.com;Trusted_Connection=no"

connStr <- paste0(driver, ";", server, ";Database=WideWorldImporters;Persist Security Info=True;UID=", creds[1], ";PWD=", creds[2], ";")
print(connStr)
...
new_orders <- data.frame(
  OrderMonth = c("2019-12-01", "2020-03-01"),
